...
%\begin{figure}[!htp]
  ...
  %\bicaption[fig:SRR]{这里将出现在插图索引中}{中文题图}{Fig}{Test Figure}
%\end{figure}
...
\begin{figure}
  ...
  \subfigure[EPS Figure]{
    \label{fig:epspdf2:a} %% label for first subfigure
    \includegraphics[width=0.3\textwidth]{chap2/testeps}}
  \hspace{1in}
  \subfigure[PDF Figure]{
    \label{fig:epspdf2:b} %% label for second subfigure
    \includegraphics[angle=-90,origin=br,width=0.3\textwidth]{chap2/testpdf.pdf}}
  \caption{插入eps图像和pdf图像}
  \label{fig:pdfeps2}
  %\bicaption[fig:pdfeps1]{插入eps图像和pdf图像}{插入eps和pdf的例子}{Fig}{An EPS and PDF demo}
\end{figure}
