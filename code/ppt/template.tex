...
$else$
    \setmainfont{Adobe 宋体 Std}
$endif$
$if(sansfont)$
    \setsansfont{$sansfont$}
$else$
    \setsansfont{Adobe 宋体 Std}
$endif$
%$if(monofont)$
...
$else$
    \setCJKmainfont[ItalicFont={Adobe Kaiti Std R}, BoldFont={Adobe Heiti Std}]{Adobe 宋体 Std}
$endif$
$if(cjksansfont)$
    \setCJKsansfont{$sansfont$}
$else$
    \setCJKsansfont[ItalicFont={Adobe Kaiti Std R},BoldFont={Adobe Heiti Std}]{Adobe 宋体 Std}
